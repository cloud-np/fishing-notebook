<script lang="ts">
	...
	// Create items array for Combobox component
...
>
	<div class="relative">
		<Gps class="text-muted-foreground absolute start-3 top-1/2 size-6 -translate-y-1/2" />
		<Combobox.Input
	...
	<Combobox.Portal>
		...
		>
			...
			<Combobox.Viewport class="p-1">
				{#each filteredLocations as item, i (i + item.value)}
					<Combobox.Item
